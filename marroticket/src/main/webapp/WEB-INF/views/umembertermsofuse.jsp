			...
			<ol class="list_terms">
				<li><span class="bullet">①</span> "이 약관에서 사용하는 용어의 정의는 다음과
					...
					<ol class="list_terms01">
						...
						<li><span class="bullet">3.</span> "회원 : 회사에 개인정보를 제공하여 회원등록을
							한 자로서, 회사가 제공하는 서비스를 계속적으로 이용할 수 있는 자로서 아래와 같이 구분될 수 있습니다."</li>
					</ol></li>
	...
	<dl>
		...
		<dd>
			<ol class="list_terms">
				...
				<li><span class="bullet">②</span> "이 약관에서 정하지 아니한 사항과 이 약관의 해석에
					관하여는 전자상거래등에서의 소비자보호에 관한 법률, 약관의 규제등에 관한 법률, 공정거래위원회가 정하는 전자상거래등에서의
				...
				<li><span class="bullet">④</span> "개정된 약관에 동의하지 않는 회원은 회원
					탈퇴(계약의 해지)를 요청할 수 있고, 약관 적용일 까지 거부의 의사를 표시하지 않으면 약관의 변경에 동의한 것으로 간주
					합니다."</li>
			</ol>
		</dd>
	</dl>
		...
		<dd>
			<ol class="list_terms">
				...
				<li><span class="bullet">②</span> "제1항에 의한 서비스 중단의 경우에는 회사는
					...
					없으며 사후에 이를 공지합니다."</li>
				<li><span class="bullet">③</span> "회사는 제1항 및 제2항 단서조항의 사유로 서비스의
					제공이 일시적으로 중단됨으로 인하여 이용자 또는 제3자가 입은 손해에 대하여 배상합니다. 단, 회사에 고의 또는 과실이
					있는 경우에 한합니다."</li>
				<li><span class="bullet">④</span> "사업종목의 전환, 사업의 포기, 업체간의 통합 등의
					이유로 서비스를 제공할 수 없게 되는 경우에는 회사는 이용자에게 통지하고 당초 회사에서 제시한 조건에 따라 소비자에게
					보상합니다. 다만, 회사가 보상기준 등을 고지하지 아니한 경우에는 이용자들의 적립금 등을 회사에서 통용되는 통화가치에

...
<form:form method="post" action="/theater/signUp"
	...
	<table border="1" class="tmemberJoinForm">
		...
		<tr>
			...
			<td class="joinInput"><form:input path="tOwnerName"
					placeholder="(필수)6자까지 입력 가능" /><font color="red"> <form:errors
						path="tOwnerName" /></font></td>
		</tr>

		<tr>
			<th class="joinWindow">개인/기업구분</th>
			<td class="joinInput"><form:radiobutton
					path="tBusinessRegistration" value="1" label="개인사업자"
					id="businessRegistration" /> <form:radiobutton
					path="tBusinessRegistration" value="2" label="법인사업자" /></td>
		</tr>

		<tr>
			<th class="joinWindow">사업자/법인 등록번호</th>
			<td class="joinInput"><form:input
					path="tBusinessRegistrationNumber" placeholder="(필수)-제외 숫자만 입력" /><font
				color="red"> <form:errors path="tBusinessRegistrationNumber" /></font></td>
		</tr>

		<tr>
			<th class="joinWindow">아이디</th>
			<td class="joinInput"><form:input path="tId"
		...
		<tr>
			...
			<td class="joinInput"><input type="Password"
				id="tPasswordConfirm" placeholder="(필수)비밀번호 재입력" /></td>
		</tr>
		<tr>
			<th class="joinWindow">극단 주소</th>
			<!-- tAddress -->
			<td class="joinInput"><input type="text" name=tAddress
				id="tAddress_postcode" placeholder="우편번호"> <input
				type="button" onclick="tAddressBtn()" value="우편번호 찾기" id=postChk><br>
				<input type="text" name='tAddress' id="tAddress_address"
				placeholder="주소"><br> <input type="text"
				name='tAddress' id="tAddress_detailAddress" placeholder="상세주소">
				<input type="text" name='tAddress' id="tAddress_extraAddress"
				placeholder="참고항목"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="joinInput"><form:input path="tName"
					placeholder="(필수)" /><font color="red"> <form:errors
						path="tName" /></font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="joinInput"><input type='date'
				name='tEstablishmentDate'><font color="red"> <form:errors
						path="tEstablishmentDate" /></font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="joinInput"><form:input path="tBankOwner"
					placeholder="(필수)예금주 성명" /><font color="red"><form:errors
						path="tBankOwner" /></font></td>
		</tr>

		<tr>
			<th class="joinWindow">사업자 등록증</th>
			<td class="joinInput"><input type="file"
				name=tBusinessRegistrationImage id="tBusinessRegistrationImage"
				accept="image/jpeg, image/png, image/jpg" /></td>

		</tr>
		<tr>
			<td colspan="2" align="center"><input type="button" value="이전"
				id="back" /> <input type="submit" value="회원가입" id="join_submit" />
			</td>
		</tr>
	</table>
</form:form>
...
input[type="submit"]:hover, input[type="button"]:hover {
	background-color: #ff3333; /* dark red */ input [type="button"] {
